package br.edu.utfpr.pena.missdc.dc.predicates;
...
public abstract class Predicate {
	...
	public boolean isTuplePairSingleColumnEquality() {
        ...
        return this instanceof TuplePairSingleColumnPredicate && op == RelationalOperator.EQUAL;
    }

	public boolean isTwoColumnEquality() {
        return this instanceof TuplePairColumnPairPredicate && op == RelationalOperator.EQUAL;
    }

	public boolean isTuplePairSingleColumnDifferentThan() {

        return this instanceof TuplePairSingleColumnPredicate && op == RelationalOperator.UNEQUAL;
    }

	public boolean isTuplePairColumnPairDifferentThan() {

        return this instanceof TuplePairColumnPairPredicate && op == RelationalOperator.UNEQUAL;
    }

	public boolean isSingleColumnRangeInequality() {

        return this instanceof TuplePairSingleColumnPredicate && op.isRangeInequality();
    }

	public abstract boolean eval(int t1, int t2);

	public boolean isTwoColumnRangeInequality() {
        return this instanceof TuplePairColumnPairPredicate && op.isRangeInequality();
    }
