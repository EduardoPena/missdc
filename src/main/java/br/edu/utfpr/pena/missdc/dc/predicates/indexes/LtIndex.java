...
public class LtIndex {
	...
	private final Float2ObjectOpenHashMap<RoaringBitmap> unsortedIndex;
...
//				 tids =RoaringBitmap.or(tids, unsortedIndex.get(value));
    ...
    public void remove(float nullFloatValue) {

		sortedEntries.remove(nullFloatValue);
		ltSortedIndex.remove(nullFloatValue);
    }
}