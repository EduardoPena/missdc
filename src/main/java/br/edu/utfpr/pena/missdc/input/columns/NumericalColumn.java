...
public class NumericalColumn extends Column {
    ...
    public NumericalColumn(String tableName, String columnName, int colID, ColumnPrimitiveType colType, FloatList copiedValuesList) {
...
//				System.out.println(sval);
            ...
            if (maximumValue < fval) maximumValue = fval;
    ...
    public boolean containsSameValue(Column otherColumn, double percentage) {
        ...
        if (!otherColumn.ColumnType.equals(this.ColumnType)) return false;
    ...
    public List<Integer> getTIDsMissing() {
        ...
        if (tidsMissing == null) {
            ...
            float floatValueForNull = NumericalColumn.DEFAULT_NULL_NUMBER;
    ...
    public Set<Float> getDomain() {
        ...
        for (float v : valuesList) {
            if (v != floatValueForNull) domain.add(v);
        }
