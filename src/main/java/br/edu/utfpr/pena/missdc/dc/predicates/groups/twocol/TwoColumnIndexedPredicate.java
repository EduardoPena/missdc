package br.edu.utfpr.pena.missdc.dc.predicates.groups.twocol;


import br.edu.utfpr.pena.missdc.dc.predicates.IndexedPredicate;
import br.edu.utfpr.pena.missdc.dc.predicates.Predicate;
import br.edu.utfpr.pena.missdc.dc.predicates.RelationalOperator;
import br.edu.utfpr.pena.missdc.dc.predicates.space.TwoColumnPredicateSpace;
import br.edu.utfpr.pena.missdc.input.columns.CategoricalColumn;
import it.unimi.dsi.fastutil.floats.Float2ObjectMap;

import java.util.BitSet;

//  we use two IndexedPredicate to represent a twoColumn predicat
...
public class TwoColumnIndexedPredicate extends IndexedPredicate {
	...
	private final TwoColumnPredicateSpace twoColspace;

	private final IndexedPredicate lhs; // we use the operator on the lhs to set the operator on this predicate

	private final RelationalOperator op;
	private final IndexedPredicate rhs;
	private final boolean isSingleTuple;
