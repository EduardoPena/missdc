...
public class Object2IndexMapper<T> {
	...
	private final Map<T, Integer> indexes = new HashMap<>();// object id is incremental

	private final List<T> objects = new ArrayList<>(); // the id of the object is its position in the array (serves as an inverted index)
